...
var Stage = (_temp = _class = function (_Component) {
  ...
  _createClass(Stage, [{
    key: '__setDimensions__REACT_HOT_LOADER__',
    value: function __setDimensions__REACT_HOT_LOADER__() {
      this.setState({
  ...
  function Stage(props) {
    ...
    _this.setDimensions = function () {
      return _this.__setDimensions__REACT_HOT_LOADER__.apply(_this, arguments);
    };
